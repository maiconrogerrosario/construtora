...
$route->get("/releases", "Web:releases");
$route->get("/predio1", "Web:predio1");
$route->get("/predio2", "Web:predio2");
...
$route->get("/mensagem", "Web:message");


//exemplos

$route->group(null);
$route->get("/exemplo", "Web:exemplo");
$route->post("/exemplo", "Web:exemplo");
$route->get("/pdf", "Web:pdf");
$route->get("/exemplo2", "Web:exemplo2");
