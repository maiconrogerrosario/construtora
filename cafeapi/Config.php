...
if (strpos($_SERVER['HTTP_HOST'], "localhost")) {
		...
		define("CONF_DB_HOST", "http:fullstackphp.mysql.dbaas.com.br");
		define("CONF_DB_USER", "fullstackphp");
		define("CONF_DB_PASS", "maicon81051049");
		define("CONF_DB_NAME", "fullstackphp");
	}
 ...
 * PROJECT URLs
 */
define("CONF_URL_BASE", "https://www.3wsoftware.com.br");
